...
*
*/
define('APP_BASE_URL', 'https://smarterp.smartnetgt.com/');
...
*/
define('APP_ENC_KEY', '8f85a28d9c01a5c050d3e5ffea6f3f84');
 ...
 */
define('APP_DB_USERNAME', 'designtech_smarterp');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Anime9010!');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'designtech_smarterp');
